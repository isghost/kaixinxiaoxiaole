...
exports.SkinnedMeshBatchRenderer = exports.SKINNEDMESHBATCHRENDERER = void 0;
const base_1 = require("../common/base");
exports.SKINNEDMESHBATCHRENDERER = {
...
class SkinnedMeshBatchRenderer {
    static create() {
        return JSON.parse(JSON.stringify(exports.SKINNEDMESHBATCHRENDERER));
    }
    static migrate(json2D) {
        return __awaiter(this, void 0, void 0, function* () {
            const source = JSON.parse(JSON.stringify(exports.SKINNEDMESHBATCHRENDERER));
    ...
    static apply(index, json2D, json3D) {
        return __awaiter(this, void 0, void 0, function* () {
            const source = yield SkinnedMeshBatchRenderer.migrate(json2D[index]);
